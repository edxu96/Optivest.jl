...
```{r, message=FALSE, fig.asp = 9/16, fig.width = 8}
ti_1 <- 
...
```{r, message=FALSE, error=FALSE, fig.asp = 9/16, fig.width = 8}
ti_2 <- 
...
ti_sensitivity %>%
  ...
  ggplot() + 
    ...
    labs(x = "Fixed Cost of Wind (DKK / %)", y = "Value",
         title = "Sensitivity of Fixed Cost of Wind in Model 1")
```
...
ti_sensitivity %>%
  ...
  ggplot() + 
    ...
    facet_grid(rows = vars(name), scales = "free") +
    labs(x = "Fixed Cost of Wind (DKK / %)", y = "Value",
         title = "Sensitivity of Fixed Cost of Wind in Model 2")
```
